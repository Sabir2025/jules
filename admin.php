...
function scan_site_files(array $managedPages): array {
    $found   = [];
    // Performance optimization: use hash map for O(1) lookup instead of O(N) in_array
    $managed = [];
    ...
    foreach ($files as $path) {
        ...
        // Performance optimization: read only first 64KB to extract <title> tag avoiding full file memory load
