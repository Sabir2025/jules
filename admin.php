...
function scan_site_files(array $managedPages): array {
    $found   = [];
    // Performance optimization: use associative array hash map for O(1) lookup
    $managed = [];
    ...
    foreach ($files as $path) {
        ...
        // Performance optimization: read max 64KB to find <title> without loading full file into memory
