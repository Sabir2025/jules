...
function scan_site_files(array $managedPages): array {
    $found   = [];
    // ⚡ Bolt Optimization: Use hash map lookup (O(1)) instead of array search (O(N))
    $managed = [];
    ...
    foreach ($files as $path) {
        ...
        // ⚡ Bolt Optimization: Limit reading to first 64KB to extract <title> without reading large files into memory
